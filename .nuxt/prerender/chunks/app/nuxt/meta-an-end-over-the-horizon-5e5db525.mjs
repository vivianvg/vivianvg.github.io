...
const _sfc_main = {
  __name: "meta-an-end-over-the-horizon",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/articles/fall-2022/meta-an-end-over-the-horizon.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=meta-an-end-over-the-horizon-5e5db525.mjs.map
