...
const _sfc_main = {
  __name: "entrepreneurship",
  __ssrInlineRender: true,
  setup(__props) {
    useSeoMeta({
      title: "Entrepreneurship",
      ogTitle: "Entrepreneurship",
      description: "Waterloo Business Review Entrepreneurship",
      ogDescription: "Waterloo Business Review Entrepreneurship",
      ogImage: ""
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="container-fluid header p-0 overflow-hidden"><div class="row"><div class="col-2"></div><div class="col-8"><h2 class="margin-bottom">Entrepreneurship</h2></div><div class="col-2"></div></div></div><!--]-->`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/entrepreneurship.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=entrepreneurship-18d4a21f.mjs.map
