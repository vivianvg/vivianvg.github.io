...
import { A as ArticlePage } from './ArticlePage-932a9aca.mjs';
import './Header-b4ff3ede.mjs';
import '../../renderer.mjs';
...
const _sfc_main = {
  __name: "tesla-the-future-of-the-electrical-industry",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(ArticlePage, mergeProps({
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/articles/fall-2022/tesla-the-future-of-the-electrical-industry.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=tesla-the-future-of-the-electrical-industry-62a1a1d7.mjs.map
